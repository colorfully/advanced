...
class BaseHtml
{
     ...
     * @return string the generated input tag
     */
    public static function activeTextInput($model, $attribute, $options = [],$type='')
    {
        self::normalizeMaxLength($model, $attribute, $options);
        if($type=='') return static::activeInput('text', $model, $attribute, $options);
        else return static::activeInput($type, $model, $attribute, $options);
